 ...
 * @author crisf
 */
@WebServlet(name = "ReporteProductosServlet", urlPatterns = {"/ReporteProductosServlet"})
...
@Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String path = getServletContext().getRealPath("/WEB-INF/reportes/reporte_productos.jasper");
