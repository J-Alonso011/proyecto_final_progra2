...
public class sr_empleado extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String fecha_nacimiento = request.getParameter("txt_fn");
            String fecha_inicio_labores = request.getParameter("txt_fil");
            String fecha_ingreso = request.getParameter("txt_fi");
            int id_puesto = Integer.parseInt(request.getParameter("drop_puesto"));
            
            boolean genero = request.getParameter("drop_genero").equals("1");
